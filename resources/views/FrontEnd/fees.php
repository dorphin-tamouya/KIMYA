...
<div id="main-wrapper"> 
  ...
  <section class="hero-wrap section">
        <div class="hero-bg hero-bg-scroll" style="background-image:url('./images/ic/fees.jpg');"></div>
  ...
  <div id="content">
                    ...
                    <div class="col-md-6 mb-5">
                        <div class="bg-white shadow-sm rounded p-4 text-center">
                            <div class="featured-box style-4 py-2">
                                ...
                                <h3 class="text-body text-7 mb-3">Recevoir de l'argent</h3>
                                <p class="text-4 line-height-4">Recevoir l'argent sans payer des frais</p>
                    ...
                    <div class="col-md-6 mb-5">
                        <div class="bg-white shadow-sm rounded p-4 text-center">
                            <div class="featured-box style-4 py-2">
                                ...
                                <h3 class="text-body text-7 mb-3">Envoyer de l'argent</h3>
                                <p class="text-4 line-height-4">Faites des transferts rapides à faible frais</p>
                                <div class="text-primary text-10 pt-3 pb-4 mb-2">Avantageux</div>
                    ...
                    <div class="col-md-6 mb-5">
                        <div class="bg-white shadow-sm rounded p-4 text-center">
                            <div class="featured-box style-4 py-2">
                                ...
                                <h3 class="text-body text-7 mb-3">Conversion de devises</h3>
                                <p class="text-4 line-height-4">Nous vous donnons toujours le taux moyen du marché, qui est le taux de change le plus juste</p>
                                <div class="text-primary text-10 pt-3 pb-4 mb-2">Jusqu'à 8.0%</div>
        ...
        <section class="section bg-primary">
            <div class="container text-center">
                <h2 class="text-9 text-white">Ouvrez un compte gratuit en quelques minutes</h2>
                <p class="text-5 text-white mb-4">Approvisionnez des portefeuilles mobiles rapidement et facilement. Plus de 40 pays et 10 devises pris en charge</p>
                <a class="btn btn-light" href="/signup">Ouvrez un compte gratuit</a>
            </div>
        </section>
        <!-- Banner end -->
